      ...
      <ul>
        ...
        <li>
          ...
          <div>
            ...
            <p>
              幂的乘方，底数不变，指数相乘。<br />
              <span class="formula"> 公式：\(( \ a^m \ ) \ ^n \ = \ a^{m \ n}\) </span> <br />
              <span class="example">
                例题：\((4y^2)^3 \ = \ ? \)，解决问题的关键是要把系数4搞清楚，要知道 \( \ 4y^2 \ = \ 4 × y × y \)，所以y的指数2，这个2是y自我相乘的次数，跟系数4没关系，但是整个算式的3次方，既是4的3次方，也是 \(y^2\)
          ...
          <div>
            ...
            <p>
              ...
              <span class="example"> 证明：2 > －4，如果不等式两边同时乘以－1会怎么样？左边变成了－2，右边呢，变成了4，－2是小于4的，这时候我们就发现，同乘一个负数，大于号变成了小于号．同样，如果我们把－2＜4这个不等式左右两边同时除以－2，左边就是1，右边是－2，左边就大于右边了。 </span>
            </p>
          </div>
          <hr />
          <div class="source-wrapper">
            <span class="source-content">
              Note 4 来源：《学好数学并不难》上册 第六章 第四节 不等式的性质：方向的改变
            </span>
          </div>
        </li>
      </ul>
